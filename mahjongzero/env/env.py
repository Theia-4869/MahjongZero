...
from mahjongzero.env.game import GameEnv
...
class Env:
    """
    MahJong multi-agent wrapper
    """
    def __init__(self, objective):
        """
        Objective is wp/adp/logadp. It indicates whether considers
        points in reward calculation. Here, we use dummy agents.
        ...
        # Initialize players
        # We use four dummy player for the target position
        self.players = {}
